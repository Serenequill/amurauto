      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6">
            ...
            >
              Лучшая автошкола<br />в Алматы
            </h2>

            <p className="text-base font-semibold mb-8" style={{ color: "#E11D48" }}>
              Ваш ключ к безопасному вождению
            </p>

            <div className="space-y-5 text-sm leading-relaxed" style={{ color: "#6B7280" }}>
              <p>
                Оборудованные аудитории, профессиональные инструкторы и квалифицированные преподаватели — всё для вашего успешного обучения.
              </p>
              <p>
                <strong style={{ color: "#111827" }}>АмурАвто</strong> — автошкола с 6 филиалами по всему Алматы.
                Тестовая программа для подготовки к ПДД,{" "}
                <strong style={{ color: "#E11D48" }}>не имеющая аналогов</strong> — 100% наших курсантов успешно сдают экзамен.
              </p>
              <p>
                Практика на 15 учебных автомобилях в отличном состоянии —{" "}
                <strong style={{ color: "#111827" }}>самый большой автопарк в Алматы</strong>.
              </p>
            </div>
            ...
            <div className="mt-6 flex items-start gap-3">
              ...
              <p className="text-sm leading-relaxed" style={{ color: "#9CA3AF" }}>
                График практических занятий обговаривается индивидуально с вашим инструктором.
              </p>
            </div>
