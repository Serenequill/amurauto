      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-10">
          ...
          <div className="md:col-span-3 md:col-start-6">
            <h4 className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: "#D1D5DB" }}>{f.navTitle}</h4>
          ...
          <div className="md:col-span-4 md:col-start-9">
            <h4 className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: "#D1D5DB" }}>{f.contactTitle}</h4>
            <div className="flex items-center gap-2 mb-1.5 text-xs" style={{ color: "#9CA3AF" }}>
              <Phone size={12} style={{ color: "#E11D48" }} />{f.callCenter}
            </div>
            ...
            <a href="#register" className="inline-block font-bold text-sm px-5 py-2.5 rounded-sm btn-primary mb-4">{f.enroll}</a>
            <div>
              <h4 className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "#D1D5DB" }}>{f.socialTitle}</h4>
              <a
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3"
          ...
          <p className="text-xs" style={{ color: "#D1D5DB" }}>{f.rights(new Date().getFullYear())}</p>
