...
export default function HeroSection() {
  ...
  /* Parallax: 3D element drifts up at 0.5× scroll speed */
  const geoY   = useTransform(scrollYProgress, [0, 1], ["0%", "-18%"]);
  /* Text drifts slightly */
    ...
    >
      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center lg:min-h-[calc(100vh-5rem)]">
          ...
          {/* ══ LEFT — 3D geometry (desktop only) ══ */}
          <div className="hidden lg:flex items-center justify-center order-2 lg:order-1 relative" style={{ minHeight: 480 }}>
            <CarScene y={geoY} />
          </div>
          ...
          >
            ...
            {/* Headline — line by line slide-in */}
            <div className="mb-5">
            ...
            {/* Urgency — glassmorphism amber pill */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <span className="text-xs" style={{ color: "#92400E", fontWeight: 400 }}>
                Осталось <strong style={{ fontWeight: 600 }}>12 мест</strong> на этот месяц
              </span>
            </motion.div>
            ...
            >
              ...
              <a
                href="#register"
                className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-sm"
                style={{
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.background = "rgba(55,138,221,0.06)";
                  el.style.transform = "translateY(-2px)";
                  el.style.boxShadow = "0 12px 24px rgba(55,138,221,0.1)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget as HTMLElement;
            ...
            <motion.div
              ...
              style={{ borderTop: `0.5px solid rgba(55,138,221,0.15)` }}
            >
              {STATS.map((s, i) => (
                <div key={s.label} className="flex items-center gap-6">
                  {i > 0 && (
                    <div style={{ width: "0.5px", height: 20,
                      background: "rgba(55,138,221,0.18)", flexShrink: 0 }} />
                  )}
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: TEXT2, fontWeight: 400,
